...
theme: /
    ...
    state: Начало
        ...
        intent!: /сыграть
        intent!: /привет
        a: Привет! Предлагаю сыграть в игру "Быки и коровы". Я загадаю 4-значное число (цифры в нем не повторяются) и подсчитаю, сколько в этом числе быков и коров. КОРОВЫ - количество угаданных цифр тайного число, а БЫКИ - сколько раз угаданная цифра стоит в нужном месте. Хочешь попробовать?
        go!: /Согласен
