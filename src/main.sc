...
theme: /
    ...
    state: Начало
        ...
        intent!: /сыграть
        intent!: /привет
        a: Привет! Я загадал тайное 4-значное число.\nЦифры в этом числе не повторяются.\nЯ подсчитаю сколько быков и коров в твоем числе. КОРОВЫ - количество угаданных цифр тайного число, а БЫКИ - сколько раз угаданная цифра стоит в нужном месте. Хочешь попробовать?
        go!: /Согласен
